...
- 图书管理（增删改查/上下架）  **[已搭建待实现]**
- 分类管理（增删改查/树结构）  **[已搭建待实现]**
...
| 功能 | 方法 | 路径 | 状态 |
|---|---|---|---|
| 图书列表（分页） | GET | /api/book/list | 已搭建待实现 |
| 图书详情 | GET | /api/book/detail/{id} | 已搭建待实现 |
| 搜索图书 | GET | /api/book/search | 已搭建待实现 |
| 热门图书 | GET | /api/book/hot | 已搭建待实现 |
| 新书推荐 | GET | /api/book/new | 已搭建待实现 |

### 4.3 分类
| 功能 | 方法 | 路径 | 状态 |
|---|---|---|---|
| 分类列表 | GET | /api/category/list | 已搭建待实现 |
| 分类树 | GET | /api/category/tree | 已搭建待实现 |
...
| 图书管理 | GET/POST/PUT/DELETE | /api/admin/book/** | 已搭建待实现 |
| 分类管理 | GET/POST/PUT/DELETE | /api/admin/category/** | 已搭建待实现 |
...
## 四、用户端功能（详细描述）
- 图书列表/分类筛选/关键词搜索/图书详情：支持分页浏览、按分类筛选、关键词检索与详情展示。**[已搭建待实现]**
...
## 五、管理员端功能模块（模块与描述）
- 管理员认证：登录、退出。**[已完成-登录]**
- 图书管理：图书 CRUD、批量导入、库存管理。**[已搭建待实现]**
- 分类管理：图书分类的增删改查。**[已搭建待实现]**
